...
const ELEMENTS := {
	...
	"Cl": preload("res://Resources/Atomons/Chlorine.tres"),
	...
	"Ne": preload("res://Resources/Atomons/Neon.tres"),
	"N": preload("res://Resources/Atomons/Nitrogen.tres"),
